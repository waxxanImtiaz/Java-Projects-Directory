...
<div id="container">
	...
	<div class="width">
    		<ul>
        		<li class=""><a href="menu.jsp">HOME</a></li>
        	    	<li class="start selected"><a href="graph.jsp">GRAPH</a></li>
    ...
    <div id="body" class="width">
		...
		<section id="content">
    <h2><%=pInfo.getName() %>i</h2>
            <h4><%=pInfo.getId() %></h4>
            <h4><%=pInfo.getDepart() %></h4>
            <h4>Dawood University Of Engineering And Technology</h4>
            <br />
     <table align="center" width="780" height="450">
             <tr>
             <td><FONT FACE="Times New Roman, Times, serif" SIZE="3"  COLOR="#990000"><b>&nbsp; RESULT GRAPH </b> </FONT> </td>
             </tr>
          <tr>
          <td height="400">  </td>
          </tr>
