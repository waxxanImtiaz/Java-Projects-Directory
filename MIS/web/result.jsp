...
<div id="container">
	...
	<div class="width">
    		<ul>
        		<li class=""><a href="menu.jsp">HOME</a></li>
        	    	<li class="start selected"><a href="result.jsp">RESULT</a></li>
    ...
    <div id="body" class="width">
      ...
      <table align="center" width="780">
            <tr><td colspan="5" width="197"> <br /><FONT FACE="Times New Roman, Times, serif" SIZE="4"  COLOR="#990000"><b>RESULT</b> </FONT></td>     
          ...
          <td colspan="4" width="206">  <FONT FACE="Times New Roman, Times, serif" SIZE="4"  COLOR="#990000"><center><b>MARKS</b></center></FONT></td>
          </tr>
          <tr>
          <td width="197">  <FONT FACE="Times New Roman, Times, serif" SIZE="4"  COLOR="#990000"> COURSE</FONT></td>
          <td colspan="2" width="206">  <FONT FACE="Times New Roman, Times, serif" SIZE="4"  COLOR="#990000"><center>THEORY MARKS </center></FONT></td>
          <td colspan="2" width="188">  <FONT FACE="Times New Roman, Times, serif" SIZE="4"  COLOR="#990000"><center>PRACTICAL MARKS</center> </FONT></td>
          </td>
          </tr>
          ...
          <tr>
          <td colspan="2" width="197">  <FONT FACE="Times New Roman, Times, serif" SIZE="4"  COLOR="#990000">GPA </FONT></td>
