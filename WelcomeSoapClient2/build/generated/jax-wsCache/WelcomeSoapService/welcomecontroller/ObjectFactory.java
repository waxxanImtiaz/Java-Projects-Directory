 ...
 * generated in the welcomecontroller package. 
...
public class ObjectFactory {
    ...
    private final static QName _Welcome_QNAME = new QName("http://welcomecontroller/", "welcome");
    private final static QName _WelcomeResponse_QNAME = new QName("http://welcomecontroller/", "welcomeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: welcomecontroller
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://welcomecontroller/", name = "welcome")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://welcomecontroller/", name = "welcomeResponse")
